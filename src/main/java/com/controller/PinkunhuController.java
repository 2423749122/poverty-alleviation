...
public class PinkunhuController {
    ...
    public R page(@RequestParam Map<String, Object> params,PinkunhuEntity pinkunhu,
		...
		if(tableName.equals("yonghu")) {
			pinkunhu.setZhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R page2(@RequestParam Map<String, Object> params,PinkunhuEntity pinkunhu,
				  HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			pinkunhu.setWordb("1");
    ...
    public R query(PinkunhuEntity pinkunhu){
		...
		return R.ok("查询贫困户成功").put("data", pinkunhuView);
    }
    ...
    public R info(@PathVariable("id") Long id){
		...
		pinkunhu.setClicknum(pinkunhu.getClicknum()+1);
		pinkunhu.setClicktime(new Date());
    ...
    public R autoSort(@RequestParam Map<String, Object> params,PinkunhuEntity pinkunhu, HttpServletRequest request,String pre){
        EntityWrapper<PinkunhuEntity> ew = new EntityWrapper<PinkunhuEntity>();
