<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家庭成员" prop="jiatingchengyuan">
          <el-input v-model="ruleForm.jiatingchengyuan" 
              placeholder="家庭成员" clearable  :readonly="ro.jiatingchengyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家庭成员" prop="jiatingchengyuan">
              <el-input v-model="ruleForm.jiatingchengyuan" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成员人数" prop="chengyuanrenshu">
          <el-input v-model="ruleForm.chengyuanrenshu" 
              placeholder="成员人数" clearable  :readonly="ro.chengyuanrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成员人数" prop="chengyuanrenshu">
              <el-input v-model="ruleForm.chengyuanrenshu" 
                placeholder="成员人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="人均收入" prop="renjunshouru">
          <el-input v-model="ruleForm.renjunshouru" 
              placeholder="人均收入" clearable  :readonly="ro.renjunshouru"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="人均收入" prop="renjunshouru">
              <el-input v-model="ruleForm.renjunshouru" 
                placeholder="人均收入" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="账号" prop="zhanghao">
          <el-input v-model="ruleForm.zhanghao" 
              placeholder="账号" clearable  readonly	></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="家庭状况" prop="jiatingzhuangkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="家庭状况"
                  v-model="ruleForm.jiatingzhuangkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiatingzhuangkuang" label="家庭状况" prop="jiatingzhuangkuang">
                    <span>{{ruleForm.jiatingzhuangkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bianhao = true;
          ...
          if(o=='jiatingchengyuan'){
            this.ruleForm.jiatingchengyuan = obj[o];
	    this.ro.jiatingchengyuan = true;
            continue;
          }
          if(o=='chengyuanrenshu'){
            this.ruleForm.chengyuanrenshu = obj[o];
	    this.ro.chengyuanrenshu = true;
            continue;
          }
          if(o=='jiatingzhuzhi'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='renjunshouru'){
            this.ruleForm.renjunshouru = obj[o];
	    this.ro.renjunshouru = true;
            continue;
          }
          if(o=='xiangxijieshao'){
	...
	this.ruleForm.xiangxijieshao = this.ruleForm.xiangxijieshao.replace(reg,'../../../springbootsudk0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
